...
FROM ghcr.io/amakata/sgw-devcontainer-base:0.2.33
...
(現在 `ghcr.io/amakata/sekimore-gw:0.2.35`) で、ここが唯一の出どころ。
...
`ghcr.io/amakata/sekimore-gw:0.2.35`。ローカルビルドでは
...
いまは揃っている (このイメージも gateway も 0.2.35)。gateway の各版が何を要求するかは
