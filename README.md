...
Dockerfile — currently `ghcr.io/amakata/sekimore-gw:0.2.34` — and by nothing else; a local
...
`ghcr.io/amakata/sekimore-gw:0.2.34`. That ARG is the only thing that decides it, and a
...
moment: this image takes 0.2.34 and the gateway is at 0.2.34. What each gateway version
