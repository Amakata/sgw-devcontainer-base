...
FROM ghcr.io/amakata/sgw-devcontainer-base:0.2.38
...
- The `sekimore-relay` CLI and `sekimore-agent-setup.sh` in this image come from gateway `ghcr.io/amakata/sekimore-gw:0.2.40` (`ARG SEKIMORE_GW_IMAGE`).
