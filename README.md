...
FROM ghcr.io/amakata/sgw-devcontainer-base:0.2.35
...
- The `sekimore-relay` CLI and `sekimore-agent-setup.sh` in this image come from gateway `ghcr.io/amakata/sekimore-gw:0.2.37` (`ARG SEKIMORE_GW_IMAGE`).
